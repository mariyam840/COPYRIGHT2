...
async def start(_, msg):
    ...
    await msg.reply_photo(
        photo="https://graph.org/file/1db954c440ccc0cdddd85.jpg",
        caption=start_txt,
...
gd_buttons = [              
        [
            ...
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/ArmanChatz"),    
        ]
        ]
